                    ...
                    <div class="col-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                @endif
                                <h4 class="mt-0 header-title">Cuaca</h4>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Buat Cuaca
                                                </h5>
                                            ...
                                            <form action="{{ route('superadmin.cuaca.create') }}" method="POST">
                                                @csrf
                                        ...
                                        @foreach ($data as $data)
                                            ...
                                            <div class="modal fade" id="Edit-{{ $data->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Edit Cuaca
                                                            </h5>
                                                            <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                        ...
                                                        <form action="{{ route('superadmin.cuaca.update', $data->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PATCH')
                                                            <div class="modal-body">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form id="deleteForm" method="POST"
                                                                action="{{ route('superadmin.cuaca.delete', $data->id) }}">
                                                                @csrf
                                                                @method('Delete')
                                                                <button type="submit"
