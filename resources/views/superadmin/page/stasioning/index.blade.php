                    ...
                    <div class="col-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                @endif
                                <h4 class="mt-0 header-title">Stasioning</h4>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Buat Stasioning
                                                </h5>
                                            ...
                                            <form action="{{ route('superadmin.stasioning.create') }}" method="POST">
                                                @csrf
                                            ...
                                            <div class="modal fade" id="Edit-{{ $data->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form
                                                            action="{{ route('superadmin.stasioning.update', $data->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PATCH')
                                                            <div class="modal-body">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form id="deleteForm" method="POST"
                                                                action="{{ route('superadmin.stasioning.delete', $data->id) }}">
                                                                @csrf
                                                                @method('Delete')
                                                                <button type="submit"
