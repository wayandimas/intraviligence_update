                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('superadmin.users.create') }}" method="POST">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="matkul">Password</label>
                                                        <input type="password" name="password" class="form-control" placeholder="Password">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleFormControlSelect1">Operasional</label>
                                                        <select class="form-control" name="operasional" id="exampleFormControlSelect1">
                                ...
                                <table id="datatable" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form method="POST" action="{{ route('superadmin.users.reset', $data->id) }}">
                                                ...
                                                @if ($data->session_token!=null)
                                                    ...
                                                    @csrf
                                                    @method('PATCH')
                                                    <button class="btn btn-success btn-sm btn-loader" type="submit">Reset</button>
                                                </form>
                                                @endif
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal fade" id="Edit-{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('superadmin.users.update', $data->id) }}" method="POST">
                                                        @csrf
                                                        @method('PATCH')
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="nama">Session Token</label>
                                                                <input type="text" name="session_token" class="form-control" value="{{ $data->session_token }}" placeholder="Session Token">
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="operasional" id="operasional">
                                                                    @foreach ($op as $item)
                                                                    <option value="{{ $item->id }}" @if ($data->operasional->id == $item->id) selected @endif>{{ $item->nama }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form id="deleteForm" method="POST" action="{{ route('superadmin.users.delete',$data->id) }}">
                                                            @csrf
                                                            @method('Delete')
