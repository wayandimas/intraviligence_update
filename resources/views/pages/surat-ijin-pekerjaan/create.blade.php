        ...
        <div class="wrapper wrapper--w960">
            <div class="card card-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('siap.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="jenis_pekerjaan" class="label">Jenis Pekerjaan (Isikan Sesuai Dengan Kotak
                                Deskripsi Pekerjaan Dalam Surat Ijin)</label>
                            <input type="text" class="form-control" placeholder="" name=jenis_pekerjaan /><small
                                class="form-text text-danger">{{ $errors->first('jenis_pekerjaan') }}</small>
                        </div>
                        <div class="form-group">
                            <label for="kontraktor" class="label">Kontraktor/Vendor (Isikan Sesuai Dengan Kotak
                                Perusahaan Dalam Surat Ijin)</label>
                            <input type="text" class="form-control" placeholder="" name=kontraktor /><small
