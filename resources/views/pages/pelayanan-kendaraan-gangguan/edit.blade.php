...
<body>
        ...
        <div class="wrapper wrapper--w960">
            <div class="card card-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('pelayanan-kendaraan-gangguan.update', $datas->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" aria-label="Default select example" name=pd>
                                    ...
                                    @foreach ($derek as $key => $data)
                                        <option value="{{ $data->id }}"
                                            {{ old('pd') == $data->id || $datas->petugas_derek == $data->id ? 'selected' : '' }}>
                                            {{ $data->nama }}
                                        </option>
                                    @endforeach
    ...
    @include('partials.js')
    <script>
        // Mendapatkan elemen input waktu kejadian, waktu sampai, dan respon time


        // function formatResponTime(responTime) {
        //     const hours = Math.floor(responTime / (1000 * 60 * 60));
        //     const minutes = Math.floor((responTime % (1000 * 60 * 60)) / (1000 * 60));
        //     const seconds = Math.floor((responTime % (1000 * 60)) / 1000);
